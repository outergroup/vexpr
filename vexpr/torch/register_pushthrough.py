...
def push_stack_through_reduction(reduction_p, parallel_reduction, shapes, expr,
    ...
    # TODO: it is very limiting to lock in the result_shape here. With GP
    # kernels, the shape here depends on how many "x1" and "x2" vectors are
    # provided. Ideally a single vectorized Vexpr will compatible with any x1
    # and x2 length, but here we build in a dependency on exactly how many
    # vectors were present during vectorization.
